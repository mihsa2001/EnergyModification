package ru.mkdata.energymod.Block.RF.Register;
...
import ru.mkdata.energymod.Block.RF.BlockEnergyHandler;
...
public class BlockEnergyHandlerRegister {
    ...
    public static final Block
            BLOCK_COUNTER = new BlockEnergyHandler("block_counter", Material.ROCK, 10.0F, 10.0F, SoundType.STONE);
